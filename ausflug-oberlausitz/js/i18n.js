...
(function () {
  ...
  var ui = {
    de: {
      ...
      heroRoute: "Dresden <span>→</span> Bautzen <span>→</span> Löbau <span>→</span> Zittau",
      ...
      photo: "Foto",
      navAria: "Abschnitte",
      navOverview: "Übersicht", navBautzen: "Bautzen", navHerrnhut: "Herrnhut", navLoebau: "Löbau", navZittau: "Zittau",
      ...
      cityBautzen: "Bautzen", cityHerrnhut: "Herrnhut", cityLoebau: "Löbau", cityZittau: "Zittau",
      bzEyebrow: "Station 1 · ca. 13:20–15:40",
      ...
      lbEyebrow: "Station 2 · ca. 16:00–18:00",
      lbTitle: "Löbau",
      lbLead: "Kleinstadt zwischen Bautzen und Zittau: barocker Altmarkt mit historischem Rathaus, die spätgotische Nikolaikirche und – etwas außerhalb – das moderne Haus Schminke sowie der gusseiserne Aussichtsturm auf dem Löbauer Berg.",
      optionalHead: "Optional – nicht im Hauptplan",
      ziEyebrow: "Station 3 · ca. 19:05–21:00",
      ziTitle: "Zittau",
      ...
      meetVal: function (t) { return "Dresden Mitte, " + t + " Uhr"; },
      meetSub: "Abfahrt RE1 Richtung Görlitz um 12:27 Uhr (Gleis bitte prüfen)",
    ...
    en: {
      ...
      photo: "Photo",
      navAria: "Sections",
      navOverview: "Overview", navBautzen: "Bautzen", navHerrnhut: "Herrnhut", navLoebau: "Löbau", navZittau: "Zittau",
      ...
      cityBautzen: "Bautzen", cityHerrnhut: "Herrnhut", cityLoebau: "Löbau", cityZittau: "Zittau",
      bzEyebrow: "Stop 1 · approx. 13:20–15:40",
      bzTitle: 'Bautzen <span class="sorb">Budyšin</span>',
      ...
      lbEyebrow: "Stop 2 · approx. 16:00–18:00",
      lbTitle: "Löbau",
      lbLead: "A small town between Bautzen and Zittau: a Baroque market square with the historic town hall, the late-Gothic St. Nicholas' Church and – just outside town – the modernist Haus Schminke and the cast-iron viewing tower on the Löbauer Berg.",
      optionalHead: "Optional – not in the main plan",
      ziEyebrow: "Stop 3 · approx. 19:05–21:00",
      ziTitle: "Zittau",
      ...
      meetVal: function (t) { return "Dresden Mitte, " + t; },
      meetSub: "RE1 towards Görlitz departs 12:27 (check the platform)",
    ...
    ko: {
      ...
      heroRoute: "드레스덴 <span>→</span> 바우첸 <span>→</span> 뢰바우 <span>→</span> 치타우",
      ...
      photo: "사진",
      navAria: "섹션",
      navOverview: "개요", navBautzen: "바우첸", navHerrnhut: "헤른후트", navLoebau: "뢰바우", navZittau: "치타우",
      ...
      cityBautzen: "바우첸", cityHerrnhut: "헤른후트", cityLoebau: "뢰바우", cityZittau: "치타우",
      bzEyebrow: "첫 번째 방문지 · 약 13:20–15:40",
      ...
      lbEyebrow: "두 번째 방문지 · 약 16:00–18:00",
      lbTitle: '뢰바우 <span class="sorb">Löbau</span>',
      lbLead: "바우첸과 치타우 사이의 소도시. 역사적인 시청이 있는 바로크 양식의 알트마르크트 광장, 후기 고딕 양식의 니콜라이 교회, 그리고 시 외곽에는 모더니즘 건축의 하우스 슈밍케와 뢰바우어 베르크의 주철 전망탑이 있습니다.",
      optionalHead: "선택 사항 – 기본 일정에는 없음",
      ziEyebrow: "세 번째 방문지 · 약 19:05–21:00",
      ...
      meetLabel: "만나는 곳",
      meetVal: function (t) { return "드레스덴 미테역, " + t; },
      meetSub: "RE1 괴를리츠 방면 12:27 출발 (승강장 확인 필요)",
  ...
  var content = {
    en: {
      "lb-altmarkt": {
        name: "Old Market & Historic Town Hall",
        text: "The Altmarkt is the Baroque heart of Löbau. The town hall was rebuilt in 1711–1714 by the Zittau master builder Prescher and houses one of the town's originally 14 “meat benches”; its tower has a moon-phase clock.",
        why: "A well-preserved Baroque market ensemble – the town's “living room” and a good starting point for a walk.",
        duration: "15–20 min", walkText: "approx. 0.5 km · 6 min from the station",
        hoursNote: "Square always accessible; town hall interior only during office hours."
      },
      "lb-nikolai": {
        name: "St. Nicholas' Church (Nikolaikirche)",
        text: "The Protestant main church, first mentioned in 1293, is a late-Gothic hall church of the 14th century; a third, southern aisle was added in 1742.",
        why: "The oldest building and spiritual centre of the old town – just a few steps from the Altmarkt.",
        duration: "10–15 min", walkText: "a few steps from the Altmarkt",
        hoursNote: "Church opening hours vary and are not reliably documented – please check on site or with the parish. Exterior any time."
      },
      "lb-schminke": {
        name: "Haus Schminke",
        text: "Home of pasta manufacturer Fritz Schminke, built 1930–1933 by Hans Scharoun – a key work of classical Modernism. It ranks alongside Villa Tugendhat, Villa Savoye and Fallingwater as one of the four most important modern houses worldwide.",
        why: "Globally iconic Modernist architecture – for anyone interested in architecture, the real reason to get off in Löbau.",
        duration: "45–60 min (only with an earlier arrival)", walkText: "approx. 0.9 km · 12 min from the station",
        hoursNote: "Thu–Sun 12:00–17:00, last entry 15:45; public tours Sat/Sun 13:00 & 15:00. Admission incl. tour €15 / reduced €10. Closed Mon–Wed.",
        planB: "⚠ Important with this late plan: arriving in Löbau around 16:00 you can effectively no longer visit Haus Schminke (last entry 15:45, last tour 15:00). Only worthwhile if you cut Bautzen short and arrive earlier – otherwise view it from outside."
      },
      "lb-turm": {
        name: "König-Friedrich-August Tower (Löbauer Berg)",
        text: "The 28 m viewing tower on the Löbauer Berg (447.9 m) was built in 1854 from around 1,000 cast-iron parts and is considered the only surviving fully cast-iron viewing tower.",
        why: "A unique technical monument with panoramic views across Upper Lusatia to the Zittau, Jizera and Giant Mountains – and, in summer, open into the evening, which makes it the best late-afternoon option.",
        duration: "60–90 min incl. the climb", walkText: "approx. 2.5 km uphill · 40–50 min (or by taxi) from the station",
        hoursNote: "Per web search May–Sep Mon–Fri 9:00–20:00, Sat/Sun 9:00–22:00; shorter in winter. Seasonal – please check.",
        reason: "Not in the main plan: the hill is outside town (~40–50 min climb). Only worthwhile if you cut Bautzen short or make Löbau your focus."
      },
      "c-hof": {
        name: "Café im Hof",
        text: "A small, cosy courtyard café in Löbau's old town with home-baked cake and ice cream.",
        hoursNote: "Opening hours not reliably documented; small cafés like this usually close around 17:00–18:00 – tight with a late arrival, please check.",
        special: "Home-baked cake, ice cream", price: "€ (estimate)", distance: "in the old town, a few minutes from the Altmarkt"
      },
      "bz-kornmarkt": {
      ...
      "wjelbik": {
        ...
        when: "late lunch, approx. 13:30–14:30",
        ...
        note: "Tight with this late start: you only reach Bautzen around 13:20 and the lunch kitchen closes at 14:00. Booking recommended – mention the late arrival, or grab a café/snack instead and have dinner in Zittau."
      },
      "moenchshof": {
        cuisine: "Historic inn, hearty food based on traditional recipes",
        when: "non-stop kitchen – good for a late arrival",
        ...
        hoursNote: "Fri 11:00–23:00 (website), non-stop kitchen. Other days according to third-party sources: closed Mon, Tue–Thu 11:00–22:00, Sun 11:00–21:00 – please check.",
        price: "€€ (estimate – check the menu)",
        note: "Thanks to the non-stop kitchen the more relaxed choice if you only reach Bautzen around 13:30."
      },
      "dornspachhaus": {
        cuisine: "Historic inn, Upper Lusatian specialities",
        when: "dinner, approx. 19:00–20:30",
        ...
        note: "Book for Friday evening – by phone or via the contact form. Leave enough time before the return train (11 min to the station)."
      },
      "altersack": {
    ...
    ko: {
      "lb-altmarkt": {
        name: "알트마르크트 & 역사적 시청",
        text: "알트마르크트는 뢰바우의 바로크 양식 중심지입니다. 시청은 1711–1714년 치타우 건축가 프레셔가 재건했으며, 원래 14개였던 ‘고기 판매대’ 중 하나가 남아 있고 탑에는 월령 시계가 있습니다.",
        why: "잘 보존된 바로크 양식의 광장 앙상블 – 도시의 ‘거실’이자 산책의 좋은 출발점입니다.",
        duration: "15–20분", walkText: "역에서 약 0.5 km · 6분",
        hoursNote: "광장은 언제나 개방; 시청 내부는 업무 시간에만."
      },
      "lb-nikolai": {
        name: "니콜라이 교회",
        text: "1293년 처음 기록된 개신교 주 교회로, 14세기 후기 고딕 양식의 홀 교회입니다. 1742년 남쪽에 세 번째 측랑이 추가되었습니다.",
        why: "구시가지에서 가장 오래된 건물이자 신앙의 중심 – 알트마르크트에서 몇 걸음 거리입니다.",
        duration: "10–15분", walkText: "알트마르크트에서 몇 걸음",
        hoursNote: "교회 개방 시간은 일정하지 않고 확실히 확인되지 않았습니다 – 현장이나 교구에 문의하세요. 외관은 언제나."
      },
      "lb-schminke": {
        name: "하우스 슈밍케",
        text: "국수 제조업자 프리츠 슈밍케의 저택으로, 1930–1933년 한스 샤로운이 지은 고전적 모더니즘의 대표작입니다. 빌라 투겐다트, 빌라 사부아, 낙수장과 함께 세계 4대 근대 주택으로 꼽힙니다.",
        why: "세계적으로 상징적인 모더니즘 건축 – 건축에 관심이 있다면 뢰바우에 내릴 진짜 이유입니다.",
        duration: "45–60분 (더 일찍 도착해야 가능)", walkText: "역에서 약 0.9 km · 12분",
        hoursNote: "목–일 12:00–17:00, 마지막 입장 15:45; 공개 가이드 투어 토/일 13:00 & 15:00. 입장료(투어 포함) 15유로 / 할인 10유로. 월–수 휴무.",
        planB: "⚠ 이 늦은 일정에서는 중요: 16시경 뢰바우 도착 시 하우스 슈밍케는 사실상 관람이 어렵습니다(마지막 입장 15:45, 마지막 투어 15:00). 바우첸을 줄여 더 일찍 도착할 때만 의미가 있고, 그렇지 않으면 외관만 보세요."
      },
      "lb-turm": {
        name: "쾨니히-프리드리히-아우구스트 탑 (뢰바우어 베르크)",
        text: "뢰바우어 베르크(447.9 m) 정상의 높이 28 m 전망탑으로, 1854년 약 1,000개의 주철 부품으로 지어졌으며 현존하는 유일한 완전 주철 전망탑으로 꼽힙니다.",
        why: "오버라우지츠 전역과 치타우·이저·거인 산맥까지 조망하는 독특한 기술 기념물이며, 여름에는 저녁까지 열어 늦은 오후에 가장 좋은 선택입니다.",
        duration: "오르는 시간 포함 60–90분", walkText: "역에서 오르막 약 2.5 km · 40–50분 (또는 택시)",
        hoursNote: "검색 기준 5–9월 월–금 9:00–20:00, 토/일 9:00–22:00; 겨울에는 더 일찍 마감. 계절에 따라 다름 – 확인 필요.",
        reason: "기본 일정에는 없음: 산이 시 외곽에 있어(약 40–50분 등반) 바우첸을 줄이거나 뢰바우를 중심으로 할 때만 의미가 있습니다."
      },
      "c-hof": {
        name: "카페 임 호프",
        text: "뢰바우 구시가지의 작고 아늑한 중정 카페로, 직접 구운 케이크와 아이스크림을 냅니다.",
        hoursNote: "영업시간이 확실히 확인되지 않았습니다; 이런 작은 카페는 보통 17–18시경 닫습니다 – 늦게 도착하면 빠듯하니 확인하세요.",
        special: "직접 구운 케이크, 아이스크림", price: "€ (추정)", distance: "구시가지, 알트마르크트에서 몇 분"
      },
      "bz-kornmarkt": {
      ...
      "wjelbik": {
        ...
        note: "이 늦은 출발에서는 빠듯합니다: 바우첸 도착이 13:20쯤이고 점심 주방은 14:00까지입니다. 예약을 권하며 늦은 도착을 미리 알리거나, 카페/간단한 요기로 대신하고 저녁을 치타우에서 드세요."
      },
      "moenchshof": {
        name: "묀히스호프 (Mönchshof)",
        cuisine: "역사적인 여관, 전통 조리법의 든든한 요리",
        when: "연속 영업 주방 – 늦은 도착에 좋음",
        text: "구시가지와 오르텐부르크 성 사이에 있는 중세풍 인테리어의 역사적인 여관입니다. 직접 구운 빵, 자체 맥주와 리큐어, 비어가든이 있습니다.",
        hoursNote: "금 11:00–23:00 (웹사이트), 주방 연속 영업. 다른 요일은 제3자 정보 기준: 월 휴무, 화–목 11:00–22:00, 일 11:00–21:00 – 확인 필요.",
        price: "€€ (추정 – 메뉴 확인)",
        note: "주방이 연속 영업이라 바우첸에 13:30쯤 도착할 때 더 여유로운 선택입니다."
      },
      "dornspachhaus": {
        name: "도른슈파흐하우스 (Dornspachhaus)",
        cuisine: "역사적인 여관, 오버라우지츠 향토 요리",
        when: "저녁, 약 19:00–20:30",
        ...
        note: "금요일 저녁이니 전화나 문의 양식으로 예약하세요. 돌아가는 기차 전에 시간을 넉넉히 두세요 (역까지 11분)."
      },
      "altersack": {
  ...
  var phrases = {
    en: {
      "Löbau": "Löbau",
      "Start am Dresden Mitte": "Start at Dresden Mitte",
      "Gleis für RE1 Richtung Görlitz prüfen": "Check the platform for the RE1 towards Görlitz",
      "RE1 Dresden Mitte → Bautzen": "RE1 Dresden Mitte → Bautzen",
      "direkt · ca. 50 Min. (Zeit prüfen)": "direct · approx. 50 min (check the time)",
      "Spätes Mittagessen (Wjelbik / Mönchshof)": "Late lunch (Wjelbik / Mönchshof)",
      "Küche im Wjelbik nur bis 14:00 – ggf. Mönchshof": "Wjelbik kitchen only until 14:00 – otherwise Mönchshof",
      "kurzer Halt": "short stop",
      "Simultankirche": "simultaneum church",
      "Burghof & Spreeblick": "castle courtyard & Spree view",
      "ca. 1,2 km · 16 Min. – zügig gehen": "approx. 1.2 km · 16 min – walk briskly",
      "RE1 Bautzen → Löbau": "RE1 Bautzen → Löbau",
      "direkt · ca. 20 Min. (Zeit prüfen)": "direct · approx. 20 min (check the time)",
      "Fußweg zum Altmarkt Löbau": "Walk to Löbau's Altmarkt",
      "Altmarkt & Rathaus": "Old Market & town hall",
      "barockes Ensemble, Mondphasenuhr": "Baroque ensemble, moon-phase clock",
      "Nikolaikirche": "St. Nicholas' Church",
      "spätgotisch, von außen": "late Gothic, from outside",
      "Freie Zeit in Löbau": "Free time in Löbau",
      "Café im Hof oder optional Löbauer Berg / Haus Schminke (Zeiten prüfen)": "Café im Hof or optionally the Löbauer Berg / Haus Schminke (check opening times)",
      "Fußweg zum Busbahnhof Löbau": "Walk to Löbau bus station",
      "direkt am Bahnhof": "right next to the train station",
      "PlusBus 10 Löbau → Zittau": "PlusBus 10 Löbau → Zittau",
      "über Herrnhut (nicht aussteigen) · ca. 55 Min. (Zeit prüfen)": "via Herrnhut (don't get off) · approx. 55 min (check the time)",
      "Marsbrunnen, „italienisches“ Rathaus": "Mars Fountain, “Italian” town hall",
      "kurzer Bummel": "a short stroll",
      "RB61 Zittau → Dresden": "RB61 Zittau → Dresden",
      "direkt · hält auch in Dresden Mitte (Zeit prüfen)": "direct · also stops at Dresden Mitte (check the time)",
      "Dresden Mitte → Bautzen": "Dresden Mitte → Bautzen",
      "Bautzen → Löbau": "Bautzen → Löbau",
      "Löbau → Zittau (PlusBus)": "Löbau → Zittau (PlusBus)",
      "Gleis prüfen": "check platform",
      "Steig prüfen": "check stand",
      "⚠ Zeiten geschätzt (ca. 50 Min., direkt, trilex RE1/RB60). Exakte Abfahrt ab Dresden Mitte in DB Navigator prüfen.": "⚠ Times estimated (approx. 50 min, direct, trilex RE1/RB60). Check the exact departure from Dresden Mitte in DB Navigator.",
      "Der langsamere RB60 hält überall und braucht länger.": "The slower RB60 stops everywhere and takes longer.",
      "Bei verpasstem Zug fährt die Linie i. d. R. etwa stündlich.": "If you miss the train, the line usually runs about hourly.",
      "⚠ Zeiten geschätzt (ca. 15–25 Min., direkt auf derselben Linie Richtung Görlitz). In DB Navigator prüfen.": "⚠ Times estimated (approx. 15–25 min, direct on the same line towards Görlitz). Check in DB Navigator.",
      "Löbau liegt zwischen Bautzen und Görlitz auf der RE1/RB60 – kein Umstieg.": "Löbau lies between Bautzen and Görlitz on the RE1/RB60 – no change.",
      "⚠ Wichtig: Es gibt KEINEN durchgehenden Zug Löbau↔Zittau (Strecke stillgelegt). Der PlusBus 10 (Löbau–Herrnhut–Zittau) ist die praktikable Verbindung, ca. 50–60 Min. Er fährt durch Herrnhut, ihr steigt aber erst in Zittau aus. Takt/Wochenendfahrten und exakte Zeit über ZVON prüfen.": "⚠ Important: there is NO through train Löbau↔Zittau (the line is closed). PlusBus 10 (Löbau–Herrnhut–Zittau) is the practical connection, approx. 50–60 min. It passes through Herrnhut, but you stay on until Zittau. Check the frequency/weekend service and exact time via ZVON.",
      "Der Bus hält vorher auch am Zittau Bahnhof – für die Altstadt bis Ottokarplatz sitzen bleiben.": "The bus also stops at Zittau Bahnhof first – for the old town, stay on until Ottokarplatz.",
      "Rein per Bahn nur mit großem Umweg über Görlitz (Löbau→Görlitz→Zittau) – deutlich länger.": "By train only via a big detour through Görlitz (Löbau→Görlitz→Zittau) – considerably longer.",
      "Direkt, ohne Umstieg, ca. 1:56 h (geschätzt)": "Direct, no change, approx. 1:56 h (estimated)",
      "Direkt, Ankunft nach Mitternacht (geschätzt)": "Direct, arrives after midnight (estimated)",
      "Nur mit kurzem/frühem Abendessen": "Only with a short/early dinner",
      "⚠ Zeiten geschätzt (trilex RE2/RB61, direkt, ca. 1:40–2:00 h; bei Baustellen/SEV länger). Der Zug hält auch in Dresden Mitte. In DB Navigator prüfen.": "⚠ Times estimated (trilex RE2/RB61, direct, approx. 1:40–2:00 h; longer during engineering works/replacement services). The train also stops at Dresden Mitte. Check in DB Navigator.",
      ...
      "ZVON – Verkehrsverbund Oberlausitz-Niederschlesien (PlusBus 10)": "ZVON – Upper Lusatia–Lower Silesia transport association (PlusBus 10)",
      "trilex / Die Länderbahn (RE1/RB60, RE2/RB61)": "trilex / Die Länderbahn (RE1/RB60, RE2/RB61)",
      "VVO-Fahrplanauskunft": "VVO journey planner",
      "Stiftung Haus Schminke, Löbau": "Haus Schminke Foundation, Löbau",
      "Stadt Löbau – König-Friedrich-August-Turm / Stadtrundgang": "Town of Löbau – König-Friedrich-August Tower / town walk",
      "Wjelbik Bautzen": "Wjelbik, Bautzen",
    ...
    ko: {
      "Löbau": "뢰바우",
      "Start am Dresden Mitte": "드레스덴 미테역에서 출발",
      "Gleis für RE1 Richtung Görlitz prüfen": "괴를리츠 방면 RE1 승강장 확인",
      "RE1 Dresden Mitte → Bautzen": "RE1 드레스덴 미테 → 바우첸",
      "direkt · ca. 50 Min. (Zeit prüfen)": "직행 · 약 50분 (시간 확인)",
      "Spätes Mittagessen (Wjelbik / Mönchshof)": "늦은 점심 (비엘빅 / 묀히스호프)",
      "Küche im Wjelbik nur bis 14:00 – ggf. Mönchshof": "비엘빅 주방은 14:00까지 – 필요시 묀히스호프",
      "kurzer Halt": "짧게 들르기",
      "Simultankirche": "공용(시물타네움) 교회",
      "Burghof & Spreeblick": "성 안뜰 & 슈프레강 전망",
      "ca. 1,2 km · 16 Min. – zügig gehen": "약 1.2 km · 16분 – 서둘러 걷기",
      "RE1 Bautzen → Löbau": "RE1 바우첸 → 뢰바우",
      "direkt · ca. 20 Min. (Zeit prüfen)": "직행 · 약 20분 (시간 확인)",
      "Fußweg zum Altmarkt Löbau": "뢰바우 알트마르크트까지 도보",
      "Altmarkt & Rathaus": "알트마르크트 & 시청",
      "barockes Ensemble, Mondphasenuhr": "바로크 앙상블, 월령 시계",
      "Nikolaikirche": "니콜라이 교회",
      "spätgotisch, von außen": "후기 고딕, 외관",
      "Freie Zeit in Löbau": "뢰바우에서 자유 시간",
      "Café im Hof oder optional Löbauer Berg / Haus Schminke (Zeiten prüfen)": "카페 임 호프 또는 선택적으로 뢰바우어 베르크 / 하우스 슈밍케 (운영 시간 확인)",
      "Fußweg zum Busbahnhof Löbau": "뢰바우 버스 터미널까지 도보",
      "direkt am Bahnhof": "기차역 바로 옆",
      "PlusBus 10 Löbau → Zittau": "PlusBus 10 뢰바우 → 치타우",
      "über Herrnhut (nicht aussteigen) · ca. 55 Min. (Zeit prüfen)": "헤른후트 경유(내리지 않음) · 약 55분 (시간 확인)",
      "Marsbrunnen, „italienisches“ Rathaus": "마르스 분수, ‘이탈리아식’ 시청",
      "kurzer Bummel": "짧은 산책",
      "RB61 Zittau → Dresden": "RB61 치타우 → 드레스덴",
      "direkt · hält auch in Dresden Mitte (Zeit prüfen)": "직행 · 드레스덴 미테에도 정차 (시간 확인)",
      "Dresden Mitte → Bautzen": "드레스덴 미테 → 바우첸",
      "Bautzen → Löbau": "바우첸 → 뢰바우",
      "Löbau → Zittau (PlusBus)": "뢰바우 → 치타우 (PlusBus)",
      "Gleis prüfen": "승강장 확인",
      "Steig prüfen": "정류장 확인",
      "⚠ Zeiten geschätzt (ca. 50 Min., direkt, trilex RE1/RB60). Exakte Abfahrt ab Dresden Mitte in DB Navigator prüfen.": "⚠ 시간은 추정치 (약 50분, 직행, trilex RE1/RB60). 드레스덴 미테 정확한 출발 시각은 DB Navigator에서 확인하세요.",
      "Der langsamere RB60 hält überall und braucht länger.": "더 느린 RB60은 모든 역에 서서 더 오래 걸립니다.",
      "Bei verpasstem Zug fährt die Linie i. d. R. etwa stündlich.": "열차를 놓치면 이 노선은 보통 약 1시간 간격으로 운행합니다.",
      "⚠ Zeiten geschätzt (ca. 15–25 Min., direkt auf derselben Linie Richtung Görlitz). In DB Navigator prüfen.": "⚠ 시간은 추정치 (약 15–25분, 괴를리츠 방면 같은 노선 직행). DB Navigator에서 확인하세요.",
      "Löbau liegt zwischen Bautzen und Görlitz auf der RE1/RB60 – kein Umstieg.": "뢰바우는 바우첸과 괴를리츠 사이 RE1/RB60 노선에 있어 환승이 없습니다.",
      "⚠ Wichtig: Es gibt KEINEN durchgehenden Zug Löbau↔Zittau (Strecke stillgelegt). Der PlusBus 10 (Löbau–Herrnhut–Zittau) ist die praktikable Verbindung, ca. 50–60 Min. Er fährt durch Herrnhut, ihr steigt aber erst in Zittau aus. Takt/Wochenendfahrten und exakte Zeit über ZVON prüfen.": "⚠ 중요: 뢰바우↔치타우 직통 열차가 없습니다(노선 폐지). PlusBus 10(뢰바우–헤른후트–치타우)이 실질적인 교통편으로 약 50–60분 걸립니다. 헤른후트를 지나가지만 치타우까지 계속 타세요. 배차/주말 운행과 정확한 시각은 ZVON에서 확인하세요.",
      "Der Bus hält vorher auch am Zittau Bahnhof – für die Altstadt bis Ottokarplatz sitzen bleiben.": "버스는 먼저 치타우역에도 섭니다 – 구시가지로 가려면 오토카르 광장까지 계속 타세요.",
      "Rein per Bahn nur mit großem Umweg über Görlitz (Löbau→Görlitz→Zittau) – deutlich länger.": "열차만으로는 괴를리츠를 크게 우회해야 하며(뢰바우→괴를리츠→치타우) 훨씬 오래 걸립니다.",
      "Direkt, ohne Umstieg, ca. 1:56 h (geschätzt)": "환승 없는 직행, 약 1시간 56분 (추정)",
      "Direkt, Ankunft nach Mitternacht (geschätzt)": "직행, 자정 이후 도착 (추정)",
      "Nur mit kurzem/frühem Abendessen": "저녁을 짧게/일찍 먹을 때만",
      "⚠ Zeiten geschätzt (trilex RE2/RB61, direkt, ca. 1:40–2:00 h; bei Baustellen/SEV länger). Der Zug hält auch in Dresden Mitte. In DB Navigator prüfen.": "⚠ 시간은 추정치 (trilex RE2/RB61, 직행, 약 1:40–2:00; 공사/대체운송 시 더 김). 이 열차는 드레스덴 미테에도 섭니다. DB Navigator에서 확인하세요.",
      "DB Navigator / bahn.de (Fahrplan bitte am Reisetag prüfen)": "DB Navigator / bahn.de (여행 당일 시간표 확인)",
      "ZVON – Verkehrsverbund Oberlausitz-Niederschlesien (PlusBus 10)": "ZVON – 오버라우지츠·니더슐레지엔 교통 연합 (PlusBus 10)",
      "trilex / Die Länderbahn (RE1/RB60, RE2/RB61)": "trilex / Die Länderbahn (RE1/RB60, RE2/RB61)",
      "VVO-Fahrplanauskunft": "VVO 시간표 조회",
      "Stiftung Haus Schminke, Löbau": "하우스 슈밍케 재단, 뢰바우",
      "Stadt Löbau – König-Friedrich-August-Turm / Stadtrundgang": "뢰바우시 – 쾨니히-프리드리히-아우구스트 탑 / 시내 산책",
      "Wjelbik Bautzen": "비엘빅, 바우첸",
